<template>
    <DefaultSection class="bg-primary py-6 md:p-8 lg:p-16">
        ...
        <CarouselStatic v-if="posts.length" :slides-per-view="{ base: 1.4, sm: 1.6, tab: 1.8, md: 1.8, lg: 1.8, xl: 2.2, xxl: 2.4 }"
            :gap="16" :show-dots="{ base: true, lg: false }" :show-arrows="{ base: false, lg: true }">
