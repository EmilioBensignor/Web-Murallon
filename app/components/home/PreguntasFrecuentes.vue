...
const mitad = computed(() => Math.ceil(faqs.length / 2))
const primeraColumna = computed(() => faqs.slice(0, mitad.value))
const segundaColumna = computed(() => faqs.slice(mitad.value))
</script>